    ...
    <div class="modal-panel">
      ...
      <fieldset class="bundle-mode-group">
        ...
        <label class="bundle-mode-option danger-option">
          ...
          <span><strong>Private backup</strong><small>Compact bot identity with OpenClaw config and secrets.</small></span>
        </label>
      </fieldset>
      <fieldset id="bundle-include-group" class="bundle-mode-group hidden" disabled>
        <legend>Private attributes</legend>
        <label class="bundle-mode-option">
          <input type="checkbox" name="bundle-include" value="sessions" />
          <span><strong>Sessions</strong><small>Conversation state and session index.</small></span>
        </label>
        <label class="bundle-mode-option">
          <input type="checkbox" name="bundle-include" value="tasks" />
          <span><strong>Tasks</strong><small>Task runner sqlite state.</small></span>
        </label>
        <label class="bundle-mode-option">
          <input type="checkbox" name="bundle-include" value="canvas" />
          <span><strong>Canvas</strong><small>Canvas page assets.</small></span>
        </label>
      </fieldset>
